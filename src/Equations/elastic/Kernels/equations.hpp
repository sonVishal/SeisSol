...
#define NUMBER_OF_ALIGNED_PHYSICAL_DOFS     (NUMBER_OF_ALIGNED_BASIS_FUNCTIONS     * NUMBER_OF_PHYSICAL_DOFS)
#define NUMBER_OF_ALIGNED_PHYSICAL_DERS     (NUMBER_OF_ALIGNED_DER_BASIS_FUNCTIONS * NUMBER_OF_QUANTITIES)
